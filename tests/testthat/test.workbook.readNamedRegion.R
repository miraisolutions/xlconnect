test_that("test.workbook.readNamedRegion", {
    wb.xls <- loadWorkbook(rsrc("resources/testWorkbookReadNamedRegion.xls"), 
        create = FALSE)
    wb.xlsx <- loadWorkbook(rsrc("resources/testWorkbookReadNamedRegion.xlsx"), 
        create = FALSE)
    ...
    expect_equal(checkDf, res)
    expect_error(readNamedRegion(wb.xls, name = "Test", header = TRUE, 
        worksheetScope = "Test"))
    expect_error(readNamedRegion(wb.xlsx, name = "Test", header = TRUE, 
        worksheetScope = "Test"))
    ...
    res <- readNamedRegion(wb.xls, name = "VariableNames", header = TRUE, 
        check.names = FALSE)
    expect_equal(target, res)
    res <- readNamedRegion(wb.xlsx, name = "VariableNames", header = TRUE, 
        check.names = FALSE)
    expect_equal(target, res)
    expect_error(readNamedRegion(wb.xls, "Conversion", header = TRUE, 
        keep = c("AAA", "BBB"), drop = c("CCC", "DDD")))
    expect_error(readNamedRegion(wb.xlsx, "Conversion", header = TRUE, 
        keep = c("AAA", "BBB"), drop = c("CCC", "DDD")))
    expect_error(readNamedRegion(wb.xls, "Conversion", header = TRUE, 
        keep = c("AAA", "BBB", "ZZZ")))
    expect_error(readNamedRegion(wb.xlsx, "Conversion", header = TRUE, 
    ...
    expect_error(readNamedRegion(wb.xlsx, "Conversion", header = TRUE, 
        drop = c(1, 2, 5)))
    AAA = data.frame(A = 1:3, B = letters[1:3], C = c(TRUE, TRUE, 
        FALSE), stringsAsFactors = FALSE)
    BBB = data.frame(D = 4:6, E = letters[4:6], F = c(FALSE, 
        TRUE, TRUE), stringsAsFactors = FALSE)
    expect_error(readNamedRegion(wb.xls, "Test", header = FALSE, 
        keep = c("NumericColumn", "BooleanColumn")))
    expect_error(readNamedRegion(wb.xlsx, "Test", header = FALSE, 
        keep = c("NumericColumn", "BooleanColumn")))
    expect_error(readNamedRegion(wb.xls, "Test", header = FALSE, 
        drop = c("StringColumn", "DateTimeColumn")))
    expect_error(readNamedRegion(wb.xlsx, "Test", header = FALSE, 
        drop = c("StringColumn", "DateTimeColumn")))
    res <- readNamedRegion(wb.xls, name = c("Test", "AAA", "BBB"), 
        header = TRUE, keep = c(1, 3))
    expect_equal(list(Test = checkDf[, c(1, 3)], AAA = AAA[, 
        c(1, 3)], BBB = BBB[, c(1, 3)]), res)
    res <- readNamedRegion(wb.xlsx, name = c("Test", "AAA", "BBB"), 
        header = TRUE, keep = c(1, 3))
    expect_equal(list(Test = checkDf[, c(1, 3)], AAA = AAA[, 
        c(1, 3)], BBB = BBB[, c(1, 3)]), res)
    res <- readNamedRegion(wb.xls, name = c("Test", "AAA", "BBB"), 
        header = TRUE, keep = list(1, 3))
    expect_equal(list(Test = checkDf[1], AAA = AAA[3], BBB = BBB[1]), 
        res)
    res <- readNamedRegion(wb.xlsx, name = c("Test", "AAA", "BBB"), 
        header = TRUE, keep = list(1, 3))
    expect_equal(list(Test = checkDf[1], AAA = AAA[3], BBB = BBB[1]), 
    ...
    expect_equal(list(Test = checkDf[, c(1, 2)], AAA = AAA[, 
        c(2, 3)], BBB = BBB[, c(1, 3)]), res)
    res <- readNamedRegion(wb.xlsx, name = c("Test", "AAA", "BBB"), 
        header = TRUE, keep = list(c(1, 2), c(2, 3), c(1, 3)))
    expect_equal(list(Test = checkDf[, c(1, 2)], AAA = AAA[, 
        c(2, 3)], BBB = BBB[, c(1, 3)]), res)
    res <- readNamedRegion(wb.xls, name = c("Test", "AAA", "BBB", 
        "Test"), header = TRUE, keep = list(c(1, 2), c(2, 3)))
    expect_equal(list(Test = checkDf[, c(1, 2)], AAA = AAA[, 
        c(2, 3)], BBB = BBB[, c(1, 2)], Test = checkDf[, c(2, 
        3)]), res)
    res <- readNamedRegion(wb.xlsx, name = c("Test", "AAA", "BBB", 
        "Test"), header = TRUE, keep = list(c(1, 2), c(2, 3)))
    expect_equal(list(Test = checkDf[, c(1, 2)], AAA = AAA[, 
    ...
    expect_equal(list(Test = checkDf[, c(3, 4)], AAA = data.frame(C = AAA[, 
        3], stringsAsFactors = F), BBB = data.frame(F = BBB[, 
        3], stringsAsFactors = F)), res)
    res <- readNamedRegion(wb.xlsx, name = c("Test", "AAA", "BBB"), 
        header = TRUE, drop = c(1, 2))
    expect_equal(list(Test = checkDf[, c(3, 4)], AAA = data.frame(C = AAA[, 
        3], stringsAsFactors = F), BBB = data.frame(F = BBB[, 
    ...
    expect_equal(list(Test = checkDf[, c(3, 4)], AAA = data.frame(A = AAA[, 
        1], stringsAsFactors = F), BBB = data.frame(E = BBB[, 
        2], stringsAsFactors = F)), res)
    res <- readNamedRegion(wb.xlsx, name = c("Test", "AAA", "BBB"), 
        header = TRUE, drop = list(c(1, 2), c(2, 3), c(1, 3)))
    expect_equal(list(Test = checkDf[, c(3, 4)], AAA = data.frame(A = AAA[, 
        1], stringsAsFactors = F), BBB = data.frame(E = BBB[, 
        2], stringsAsFactors = F)), res)
    res <- readNamedRegion(wb.xls, name = c("Test", "AAA", "BBB", 
        "Test"), header = TRUE, drop = list(c(1, 2), c(2, 3)))
    expect_equal(list(Test = checkDf[, c(3, 4)], AAA = data.frame(A = AAA[, 
        1], stringsAsFactors = F), BBB = data.frame(F = BBB[, 
        3], stringsAsFactors = F), Test = checkDf[, c(1, 4)]), 
        res)
    res <- readNamedRegion(wb.xlsx, name = c("Test", "AAA", "BBB", 
        "Test"), header = TRUE, drop = list(c(1, 2), c(2, 3)))
    expect_equal(list(Test = checkDf[, c(3, 4)], AAA = data.frame(A = AAA[, 
        ...
        3], stringsAsFactors = F), Test = checkDf[, c(1, 4)]), 
        res)
    targetNoForceSubset <- data.frame(BBB = c("hello", "42.24", 
        "true", NA, "11.01.1984 12:00:00"), DDD = as.POSIXct(c("1984-01-11 12:00:00", 
        NA, NA, NA, NA)), stringsAsFactors = FALSE)
    res <- readNamedRegion(wb.xls, name = "Conversion", header = TRUE, 
        colTypes = c(XLC$DATA_TYPE.NUMERIC, XLC$DATA_TYPE.STRING, 
            XLC$DATA_TYPE.BOOLEAN, XLC$DATA_TYPE.DATETIME), forceConversion = FALSE, 
        dateTimeFormat = "%d.%m.%Y %H:%M:%S", keep = c("BBB", 
            "DDD"))
    ...
    res <- readNamedRegion(wb.xls, name = "Conversion", header = TRUE, 
        colTypes = c(XLC$DATA_TYPE.NUMERIC, XLC$DATA_TYPE.STRING, 
            XLC$DATA_TYPE.BOOLEAN, XLC$DATA_TYPE.DATETIME), forceConversion = FALSE, 
        dateTimeFormat = "%d.%m.%Y %H:%M:%S", drop = c("AAA", 
            "CCC"))
    expect_equal(targetNoForceSubset, res)
    res <- readNamedRegion(wb.xlsx, name = "Conversion", header = TRUE, 
        colTypes = c(XLC$DATA_TYPE.NUMERIC, XLC$DATA_TYPE.STRING, 
    ...
    res <- readNamedRegion(wb.xlsx, name = "Conversion", header = TRUE, 
        ...
        dateTimeFormat = "%d.%m.%Y %H:%M:%S", drop = c(1, 3))
    expect_equal(targetNoForceSubset, res)
    res <- readNamedRegion(wb.xls, name = "Simplify1", header = TRUE, 
        simplify = TRUE)
    expect_equal(1:10, res)
    res <- readNamedRegion(wb.xls, name = "Simplify2", header = TRUE, 
        simplify = TRUE)
    expect_equal(1:4, res)
    res <- readNamedRegion(wb.xls, name = "Simplify3", header = TRUE, 
        simplify = TRUE)
    expect_equal(c(TRUE, FALSE, FALSE, TRUE), res)
    res <- readNamedRegion(wb.xls, name = "Simplify4", header = TRUE, 
        simplify = TRUE)
    expect_equal(c("one", "two", "three", "four", "five"), res)
    res <- readNamedRegion(wb.xlsx, name = "Simplify1", header = TRUE, 
        simplify = TRUE)
    expect_equal(1:10, res)
    res <- readNamedRegion(wb.xlsx, name = "Simplify2", header = TRUE, 
        simplify = TRUE)
    expect_equal(1:4, res)
    res <- readNamedRegion(wb.xlsx, name = "Simplify3", header = TRUE, 
        simplify = TRUE)
    expect_equal(c(TRUE, FALSE, FALSE, TRUE), res)
    ...
    res <- readNamedRegionFromFile(rsrc("resources/testBug49.xlsx"), 
    ...
    readBoth <- readNamedRegion(wb37xlsx, name, worksheetScope = c("Sheet1", 
        "Sheet2"))
