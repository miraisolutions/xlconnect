...
.onLoad <- function(libname, pkgname) {
  ...
  sharedPaths <- tryCatch({
    c(
      ...
      paste0(apachePrefix, "/poi/poi-ooxml-schemas/5.2.2/poi-ooxml-schemas-5.2.2.jar"), "poi-ooxml-schemas.jar", 
    ...
    xlcEnsureDependenciesFor(
      ...
      "5.2.2",  libname, pkgname, debianpkg = "libapache-poi-java", rpmpkg="apache-poi"),
    xlcEnsureDependenciesFor(
      paste0(apachePrefix, "/poi/poi/5.2.2/poi-5.2.2.jar"), "poi.jar", 
      "5.2.2",  libname, pkgname, debianpkg = "libapache-poi-java", rpmpkg="apache-poi"),
    xlcEnsureDependenciesFor(
    ...
    xlcEnsureDependenciesFor(
      paste0(apachePrefix, "/logging/log4j/log4j-api/2.17.2/log4j-api-2.17.2.jar"), "xmlbeans.jar",
