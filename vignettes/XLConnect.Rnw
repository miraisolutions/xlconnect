...
{\small\urlwofont{http://www.mirai-solutions.com}}\\[-0.3cm]
...
\author{\small{Author of this Vignette:}	\\\textcolor{Fuchsia}{\bf{Anna Maria Ksiezopolska}}, \\\small{\href{http://www.mirai-solutions.com}{\textcolor{Black}{Mirai Solutions GmbH}}}}
...
\begin{itemize}
  \item{Moved to Apache POI 3.17}
  \item{Upgraded XLConnectJars dependency to version 0.2-14}
  \item{Fixed Java version specification in system requirements}
  \item{Checking Java version at runtime according to CRAN requirements}
  \item{Added existsCellStyle to check for existence of cell styles (\#71)}
  \item{Added getOrCreateCellStyle combinator (\#14, \#71)}
  \item{Updates to vignettes}
\end{itemize}
...
\begin{enumerate}
	...
	\item Quick Intro to \pkg{XLConnect}:
	    \\\urlwofont{http://altons.github.io/rstats/2015/02/13/quick-intro-to-xlconnect/}
  ...
  \item R and Excel: Making Your Data Dumps Pretty with XLConnect:
      ...
      \\\urlwofont{http://amunategui.github.io/excel-data-dumps/}
\end{enumerate}
